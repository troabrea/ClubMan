...
public class AgregarHuespedService : MovimientoService
{
    ...
    public AgregarHuespedService(IDocumentSession session, MovimientoSocio movimientoSocio, ICarnetService carnetService) : base(session, movimientoSocio)
    {
...
public class QuitarHuespedService : MovimientoService
{
    ...
    public QuitarHuespedService(IDocumentSession session, MovimientoSocio movimientoSocio, ICarnetService carnetService) : base(session, movimientoSocio)
    {
        _carnetService = carnetService;
    }

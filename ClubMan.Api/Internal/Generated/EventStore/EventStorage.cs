...
namespace Marten.Generated.EventStore
{
    ...
    public class GeneratedEventDocumentStorage : Marten.Events.EventDocumentStorage
    {
        ...
        {
            return new Marten.Generated.EventStore.GeneratedStreamStateQueryHandler(stream.Key, stream.TenantId);
        }
    ...
    public class GeneratedInsertStream : Marten.Events.Operations.InsertStreamBase
    {
        ...
        public const string SQL = "insert into public.mt_streams (id, tenant_id, type, version) values (?, ?, ?, ?)";
        ...
        public override void ConfigureCommand(Weasel.Postgresql.CommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            ...
            parameters[1].Value = Stream.TenantId != null ? (object)Stream.TenantId : System.DBNull.Value;
            parameters[1].NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Text;
            parameters[2].Value = Stream.AggregateTypeName != null ? (object)Stream.AggregateTypeName : System.DBNull.Value;
            parameters[2].NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Text;
            parameters[3].Value = Stream.Version;
            parameters[3].NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Bigint;
        }
    ...
    public class GeneratedStreamStateQueryHandler : Marten.Events.Querying.StreamStateQueryHandler
    {
        ...
        public GeneratedStreamStateQueryHandler(string streamId, string tenantId)
        {
            _streamId = streamId;
            _tenantId = tenantId;
        }
        ...
        public const string SQL = "select id, version, type, timestamp, created as timestamp, is_archived from public.mt_streams where id = ? and tenant_id = ?";
        ...
        public override void ConfigureCommand(Weasel.Postgresql.CommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            ...
            npgsqlParameterArray[1].Value = _tenantId;
            npgsqlParameterArray[1].DbType = System.Data.DbType.String;
        }
    ...
    public class GeneratedStreamVersionOperation : Marten.Events.Operations.UpdateStreamVersion
    {
        ...
        public const string SQL = "update public.mt_streams set version = ? where id = ? and version = ? and tenant_id = ?";

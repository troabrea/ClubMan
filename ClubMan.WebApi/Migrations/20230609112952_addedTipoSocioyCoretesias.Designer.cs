...
namespace ClubMan.WebApi.Migrations
{
    ...
    [Migration("20230609112952_addedTipoSocioyCoretesias")]
    partial class addedTipoSocioyCoretesias
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClubMan.Shared.Model.Cobro", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ClubMan.Shared.Model.Empresa", b =>
                {
                    ...
                    b.Property<string>("SandboxServiceUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ClubMan.Shared.Model.UsuarioApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClubMan.Shared.Model.VisitaManual", b =>
                {
                    ...
                    b.ToTable("VisitaManual", (string)null);
                });
            ...
            modelBuilder.Entity("ClubMan.Shared.Model.Cobro", b =>
                {
                    b.OwnsMany("ClubMan.Shared.Model.CobroAplicacion", "Aplicaciones", b1 =>
                        {
                            b1.Property<long>("CobroId")
                                .HasColumnType("bigint");
                            ...
                            b1.Property<string>("IdDocumento")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<decimal>("Pagado")
                                .HasColumnType("decimal(18,2)");

                            b1.HasKey("CobroId", "Id");

                            b1.ToTable("CobroAplicacion");
                    ...
                    b.OwnsMany("ClubMan.Shared.Model.Embarcacion", "Embarcaciones", b1 =>
                        {
                            ...
                            b1.Property<string>("PermisoNavegacion")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("Seguro")
                                .HasColumnType("nvarchar(max)");
